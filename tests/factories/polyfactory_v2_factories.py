"""
Фабрики для polyfactory 2.x с правильным API
"""
...
class PassengerFactoryV2(BaseFactory):
    """Фабрика для создания тестовых пассажиров (polyfactory 2.x)"""
...
class BusFactoryV2(BaseFactory):
    """Фабрика для создания тестовых автобусов (polyfactory 2.x)"""
...
class ReservationFactoryV2(BaseFactory):
    """Фабрика для создания тестовых бронирований (polyfactory 2.x)"""
...
class WaitingListRecordFactoryV2(BaseFactory):
    """Фабрика для создания тестовых записей листа ожидания (polyfactory 2.x)"""
...
class BusOwnerFactoryV2(BaseFactory):
    """Фабрика для создания тестовых владельцев автобусов (polyfactory 2.x)"""
