...
FAQ_TEXT = (
    ...
    "\n"
    "7. **Куда писать, если ничего не работает?** Если бот не пускает или что-то сломалось, напиши Леониду @kosolapovlu или в общий чат ProductCamp во вкладку «Трансфер»\n"
    "\n"
