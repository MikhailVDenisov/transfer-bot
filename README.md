...
Transfer Bot - это современный Telegram бот, разработанный для автоматизации процесса бронирования трансферов на корпоративные мероприятия. Бот позволяет сотрудникам легко бронировать места в автобусах, управлять своими бронированиями, заполнять персональные данные и получать уведомления о доступных местах. Для администраторов и шефов автобусов предусмотрены отдельные инструменты: выгрузки в Excel, рассылки пассажирам и работа с назначенными автобусами.
...
- 🪪 **Персональные данные** - Ввод, проверка и подтверждение ФИО, телефона, даты рождения, паспорта и гражданства
- 📊 **Экспорт данных** - Экспорт списков пассажиров и персональных данных в Excel
- 🔍 **Фильтрация по направлениям** - Поиск автобусов по нужному направлению
- 🚌 **Шеф автобуса** - Рассылка сообщений пассажирам назначенного автобуса и выгрузка списка пассажиров
- 🧾 **Ручные резервы** - Учет заранее зарезервированных мест по Telegram username
- 👥 **Управление пользователями** - Система ролей (пользователь/администратор/шеф)
