...
async def render_faq(update: Update, context: ContextTypes.DEFAULT_TYPE):
    faq_text = (
        ...
        "\n"
        "7. **Куда писать, если ничего не работает?** Если бот не пускает или что-то сломалось, напиши Нике @havingfreckles или в [общий чат](https://t.me/c/2339287372/1173) ProductCamp во вкладку «Трансфер»\n"
        "\n"
